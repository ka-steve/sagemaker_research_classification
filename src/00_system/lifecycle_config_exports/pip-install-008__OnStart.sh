...
echo ":: cd /home/ec2-user/SageMaker/research_methodology_extraction/src/00_system/ && ls && pwd && python on_start.py"
cd /home/ec2-user/SageMaker/research_methodology_extraction/src/00_system/ && ls && pwd && python on_start.py
